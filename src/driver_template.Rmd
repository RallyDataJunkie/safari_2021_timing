...
caption = paste0(stage_info_$code, ' split delta — ', driverCode, ' — ', rally_name)
#driver_rebased
```
...
caption = paste0(stage_info_$code, ' split section delta — ', driverCode, ' - ', rally_name)
...
caption = paste0(stage_info_$code, ' split section pace delta — ', driverCode, ' - ', rally_name)
