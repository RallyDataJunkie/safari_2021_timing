...
author: "Tony Hirst"
description: "Stage results, WRC Safari Rally Kenya, 2021"
...
```{r}
s = get_active_season()
eventId = get_eventId_from_name(s, 'kenya')
...
The RallyDataJunkie project, such as it is, is a personal exploration of various ways of representing and visualising rally related stage, timing and results data.

There are several potential audiences:

- rally fans, looking for summaries of rally events;
- teams and crews, looking for viariously arranged summaries to check and compare performances;
- commentators and journnalists, looking for variously arranged summaries and overviews as a tool for confirming or identifying storypoints;
